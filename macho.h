...
public:
	...
	bool Free();
	void PrintInfo();
	bool Sign(arksigningAsset *pSignAsset, bool bForce, string strBundleId, string strInfoPlistSHA1, string strInfoPlistSHA256, const string &strCodeResourcesData);
